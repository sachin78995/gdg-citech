      ...
      >
        ...
        <div className="profile__layout">
          ...
          <div className="profile__right">
            ...
            <p className="profile__role">{member.role}</p>

            <div className="profile__section">
              <h4 className="profile__label">About</h4>
              <p className="profile__bio">{member.bio}</p>
            </div>

            <div className="profile__section">
              <h4 className="profile__label">Tech Stack</h4>
            ...
            <div className="profile__section">
              <h4 className="profile__label">Highlights</h4>
              <div className="profile__stats">
                ...
                <div className="profile__stat">
                  <span className="profile__stat-num">500+</span>
                  <span className="profile__stat-label">Contributions</span>
                </div>
                <div className="profile__stat">
                  <span className="profile__stat-num">2+</span>
                  <span className="profile__stat-label">Years</span>
                </div>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div className="member__right">
        ...
        <div className="member__skills">
          {member.skills.map((skill) => (
            <span key={skill} className="member__skill">{skill}</span>
          ))}
        </div>
      </div>
